...
namespace Lesson01
{
    ...
    public class Customer
    {
        ...
        {
            Console.WriteLine("Fish is eated.");
        }

        public void Eat(Chicken c)
        {
            Console.WriteLine("Chicken is eated.");
        }

        public void Eat(Beef b)
        {
            Console.WriteLine("Beef is eated.");
        }
    ...
    public class Food
    {
        ...
        {
            Console.WriteLine("Food is eated.");
        }
    }
