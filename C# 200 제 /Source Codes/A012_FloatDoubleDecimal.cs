...
namespace Practice
{
	public class A012_FloatDoubleDecimal
	{
		static void Main(string[] args)
        {
			float flt = 1F / 3;		// 1F : flaot 1
			double dbl = 1D / 3;	// 1D : double 1
			decimal dcm = 1M / 3;	// 1M : decimal 1
			...
			Console.WriteLine("flaot	: {0} ~ {1}", float.MinValue, float.MaxValue);
